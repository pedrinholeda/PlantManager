...
exports.version = "17.0.3-experimental-8f202a7c8";
        ...
        if (isProfiling && root.memoizedInteractions != null) {
          ...
          currentCommitProfilingMetadata = {
            ...
            interactions: Array.from(root.memoizedInteractions).map(function (interaction) {
              return renderer_objectSpread(renderer_objectSpread({}, interaction), {}, {
...
var agent_Agent = /*#__PURE__*/function (_EventEmitter) {
  ...
  function Agent(bridge) {
    ...
    agent_defineProperty(_assertThisInitialized(_this), "_isProfiling", false);

    agent_defineProperty(_assertThisInitialized(_this), "_recordChangeDescriptions", false);

    agent_defineProperty(_assertThisInitialized(_this), "_rendererInterfaces", {});

    agent_defineProperty(_assertThisInitialized(_this), "_persistedSelection", null);

    agent_defineProperty(_assertThisInitialized(_this), "_persistedSelectionMatch", null);

    agent_defineProperty(_assertThisInitialized(_this), "_traceUpdatesEnabled", false);

    agent_defineProperty(_assertThisInitialized(_this), "clearErrorsAndWarnings", function (_ref) {
    ...
    agent_defineProperty(_assertThisInitialized(_this), "clearErrorsForFiberID", function (_ref2) {
      var id = _ref2.id,
    ...
    agent_defineProperty(_assertThisInitialized(_this), "clearWarningsForFiberID", function (_ref3) {
      var id = _ref3.id,
    ...
    agent_defineProperty(_assertThisInitialized(_this), "copyElementPath", function (_ref4) {
      var id = _ref4.id,
          path = _ref4.path,
    ...
    agent_defineProperty(_assertThisInitialized(_this), "deletePath", function (_ref5) {
    ...
    agent_defineProperty(_assertThisInitialized(_this), "getProfilingData", function (_ref6) {
    ...
    agent_defineProperty(_assertThisInitialized(_this), "getProfilingStatus", function () {
      _this._bridge.send('profilingStatus', _this._isProfiling);
    });

    agent_defineProperty(_assertThisInitialized(_this), "getOwnersList", function (_ref7) {
      var id = _ref7.id,
    ...
    agent_defineProperty(_assertThisInitialized(_this), "inspectElement", function (_ref8) {
      var id = _ref8.id,
          path = _ref8.path,
    ...
    agent_defineProperty(_assertThisInitialized(_this), "logElementToConsole", function (_ref9) {
      var id = _ref9.id,
    ...
    agent_defineProperty(_assertThisInitialized(_this), "overrideSuspense", function (_ref10) {
      var id = _ref10.id,
    ...
    agent_defineProperty(_assertThisInitialized(_this), "overrideValueAtPath", function (_ref11) {
    ...
    agent_defineProperty(_assertThisInitialized(_this), "overrideContext", function (_ref12) {
      var id = _ref12.id,
          path = _ref12.path,
    ...
    agent_defineProperty(_assertThisInitialized(_this), "overrideHookState", function (_ref13) {
      var id = _ref13.id,
    ...
    agent_defineProperty(_assertThisInitialized(_this), "overrideProps", function (_ref14) {
      var id = _ref14.id,
          path = _ref14.path,
    ...
    agent_defineProperty(_assertThisInitialized(_this), "overrideState", function (_ref15) {
      var id = _ref15.id,
          path = _ref15.path,
    ...
    agent_defineProperty(_assertThisInitialized(_this), "reloadAndProfile", function (recordChangeDescriptions) {
    ...
    agent_defineProperty(_assertThisInitialized(_this), "renamePath", function (_ref16) {
    ...
    agent_defineProperty(_assertThisInitialized(_this), "setTraceUpdatesEnabled", function (traceUpdatesEnabled) {
    ...
    agent_defineProperty(_assertThisInitialized(_this), "syncSelectionFromNativeElementsPanel", function () {
    ...
    agent_defineProperty(_assertThisInitialized(_this), "shutdown", function () {
      // Clean up the overlay if visible, and associated events.
      _this.emit('shutdown');
    });

    agent_defineProperty(_assertThisInitialized(_this), "startProfiling", function (recordChangeDescriptions) {
    ...
    agent_defineProperty(_assertThisInitialized(_this), "stopProfiling", function () {
    ...
    agent_defineProperty(_assertThisInitialized(_this), "storeAsGlobal", function (_ref17) {
    ...
    agent_defineProperty(_assertThisInitialized(_this), "updateConsolePatchSettings", function (_ref18) {
    ...
    agent_defineProperty(_assertThisInitialized(_this), "updateComponentFilters", function (componentFilters) {
      for (var rendererID in _this._rendererInterfaces) {
        var renderer = _this._rendererInterfaces[rendererID];
    ...
    agent_defineProperty(_assertThisInitialized(_this), "viewAttributeSource", function (_ref19) {
      var id = _ref19.id,
          path = _ref19.path,
    ...
    agent_defineProperty(_assertThisInitialized(_this), "viewElementSource", function (_ref20) {
      var id = _ref20.id,
    ...
    agent_defineProperty(_assertThisInitialized(_this), "onTraceUpdates", function (nodes) {
      _this.emit('traceUpdates', nodes);
    });

    agent_defineProperty(_assertThisInitialized(_this), "onHookOperations", function (operations) {
      if (__DEBUG__) {
    ...
    agent_defineProperty(_assertThisInitialized(_this), "_throttledPersistSelection", lodash_throttle_default()(function (rendererID, id) {
...
var Bridge = /*#__PURE__*/function (_EventEmitter) {
  ...
  function Bridge(wall) {
    ...
    bridge_defineProperty(bridge_assertThisInitialized(_this), "overrideValueAtPath", function (_ref) {
      var id = _ref.id,
          path = _ref.path,
          rendererID = _ref.rendererID,
          type = _ref.type,
